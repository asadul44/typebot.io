...
var typebotContext = (0, import_react.createContext)({});
var TypebotProvider = ({
  children,
  typebot,
  apiHost,
  ...
  const [localTypebot, setLocalTypebot] = (0, import_react.useState)(typebot);
  const [linkedTypebots, setLinkedTypebots] = (0, import_react.useState)([]);
  const [currentTypebotId, setCurrentTypebotId] = (0, import_react.useState)(typebot.typebotId);
  const [linkedBotQueue, setLinkedBotQueue] = (0, import_react.useState)([]);
  const [parentTypebotIds, setParentTypebotIds] = (0, import_react.useState)([]);
...
var useTypebot = () => (0, import_react.useContext)(typebotContext);
...
var import_react_transition_group3 = require("react-transition-group");
    ...
    "figure",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("mask", { id: "mask0", x: "0", y: "0", "mask-type": "alpha", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "37.5", cy: "37.5", r: "37.5", fill: "#0042DA" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { mask: "url(#mask0)", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { x: "-30", y: "-43", width: "131", height: "154", fill: "#0042DA" }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "76.5", cy: "-1.5", r: "29", stroke: "#FF8E20", strokeWidth: "5" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "path",
                {
...
var Avatar = ({ avatarSrc }) => {
  const [currentAvatarSrc] = (0, import_react2.useState)(avatarSrc);
  if (currentAvatarSrc === "")
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(DefaultAvatar, {});
};
...
var AvatarSideContainer = (0, import_react3.forwardRef)(function AvatarSideContainer2({ hostAvatarSrc, keepShowing }, ref) {
  const [show, setShow] = (0, import_react3.useState)(false);
  const [avatarTopOffset, setAvatarTopOffset] = (0, import_react3.useState)(0);
  ...
  const scrollingSideGroupRef = (0, import_react3.useRef)(null);
  const avatarContainer = (0, import_react3.useRef)(null);
  ...
  (0, import_react3.useEffect)(() => {
    if (!document)
      return;
    setShow(true);
    const resizeObserver = new import_resize_observer.ResizeObserver(refreshTopOffset);
        ...
        import_react_transition_group.CSSTransition,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "div",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Avatar, { avatarSrc: hostAvatarSrc })
            }
          )
        }
      )
...
var import_prisma = require("@typebot.io/prisma");
var workspaceMemberSchema = z.object({
  ...
  role: z.nativeEnum(import_prisma.WorkspaceRole)
});
var workspaceInvitationSchema = z.object({
  createdAt: z.date(),
  updatedAt: z.date(),
  email: z.string(),
  type: z.nativeEnum(import_prisma.WorkspaceRole)
});
var workspaceSchema = z.object({
  ...
  name: z.string(),
  icon: z.string().nullable(),
  plan: z.nativeEnum(import_prisma.Plan),
...
var TypingBubble = () => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex items-center", children: [
  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "w-2 h-2 mr-1 rounded-full bubble1" }),
  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "w-2 h-2 mr-1 rounded-full bubble2" }),
  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "w-2 h-2 rounded-full bubble3" })
] });
...
var AudioBubble = ({ url, onTransitionEnd }) => {
  ...
  const [isTyping, setIsTyping] = (0, import_react4.useState)(true);
  const [parsedUrl] = (0, import_react4.useState)(parseVariables(typebot.variables)(url));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "flex flex-col", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "flex mb-2 w-full lg:w-11/12 items-center", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex relative z-10 items-start typebot-host-bubble", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      "div",
      {
        ...
        children: isTyping ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TypingBubble, {}) : null
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      "audio",
...
var EmbedBubble = ({ block, onTransitionEnd }) => {
  var _a2;
  const { typebot, isLoading } = useTypebot();
  const messageContainer = (0, import_react5.useRef)(null);
  const [isTyping, setIsTyping] = (0, import_react5.useState)(true);
  const [url] = (0, import_react5.useState)(parseVariables(typebot.variables)((_a2 = block.content) == null ? void 0 : _a2.url));
  const onTypingEnd = (0, import_react5.useCallback)(() => {
    setIsTyping(false);
    setTimeout(() => {
      onTransitionEnd();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex flex-col w-full", ref: messageContainer, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex mb-2 w-full lg:w-11/12 items-center", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          "div",
          {
            ...
            children: isTyping ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(TypingBubble, {}) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, {})
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          "iframe",
...
var ImageBubble = ({ block, onTransitionEnd }) => {
  var _a2;
  const { typebot, isLoading } = useTypebot();
  const messageContainer = (0, import_react6.useRef)(null);
  const image = (0, import_react6.useRef)(null);
  const [isTyping, setIsTyping] = (0, import_react6.useState)(true);
  const [url] = (0, import_react6.useState)(parseVariables(typebot.variables)((_a2 = block.content) == null ? void 0 : _a2.url));
  const onTypingEnd = (0, import_react6.useCallback)(() => {
    setIsTyping(false);
    setTimeout(() => {
      onTransitionEnd();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "flex flex-col", ref: messageContainer, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "flex mb-2 w-full lg:w-11/12 items-center", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex relative z-10 items-start typebot-host-bubble", children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      "div",
      {
        ...
        children: isTyping ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(TypingBubble, {}) : null
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      "img",
...
var TextBubble = ({ block, onTransitionEnd }) => {
  var _a2;
  const { typebot, isLoading } = useTypebot();
  const messageContainer = (0, import_react7.useRef)(null);
  const [isTyping, setIsTyping] = (0, import_react7.useState)(true);
  const [content] = (0, import_react7.useState)(
    parseVariables(typebot.variables)(block.content.html)
  );
  const onTypingEnd = (0, import_react7.useCallback)(() => {
    setIsTyping(false);
    setTimeout(() => {
      onTransitionEnd();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "flex flex-col", ref: messageContainer, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "flex mb-2 w-full items-center", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex relative items-start typebot-host-bubble", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "div",
      {
        ...
        children: isTyping ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TypingBubble, {}) : null
      }
    ),
    block.type === "text" /* TEXT */ && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "p",
      {
        style: {
...
var VideoBubble = ({ block, onTransitionEnd }) => {
  const { typebot, isLoading } = useTypebot();
  const messageContainer = (0, import_react8.useRef)(null);
  const [isTyping, setIsTyping] = (0, import_react8.useState)(true);
  const onTypingEnd = (0, import_react8.useCallback)(() => {
    setIsTyping(false);
    setTimeout(() => {
      onTransitionEnd();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "flex flex-col", ref: messageContainer, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "flex mb-2 w-full lg:w-11/12 items-center", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex relative z-10 items-start typebot-host-bubble", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "div",
      {
        ...
        children: isTyping ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(TypingBubble, {}) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_jsx_runtime10.Fragment, {})
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      VideoContent,
...
var VideoContent = ({
  ...
  const [url] = (0, import_react8.useState)(parseVariables(variables)(content == null ? void 0 : content.url));
    ...
    case "url" /* URL */: {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
        "video",
        {
          ...
          autoPlay: true,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("source", { src: url, type: "video/mp4" }),
...
var HostBubble = ({ block, onTransitionEnd }) => {
  switch (block.type) {
    case "text" /* TEXT */:
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(TextBubble, { block, onTransitionEnd });
    case "image" /* IMAGE */:
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ImageBubble, { block, onTransitionEnd });
    case "video" /* VIDEO */:
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(VideoBubble, { block, onTransitionEnd });
    case "embed" /* EMBED */:
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(EmbedBubble, { block, onTransitionEnd });
    case "audio" /* AUDIO */:
...
var answersContext = (0, import_react9.createContext)({});
var AnswersProvider = ({
  children,
  resultId,
  onNewAnswer,
  ...
  const [resultValues, setResultValues] = (0, import_react9.useState)({
    answers: [],
    variables: [],
    createdAt: new Date()
  });
...
var useAnswers = () => (0, import_react9.useContext)(answersContext);
...
var GuestBubble = ({
  ...
  const [content] = (0, import_react10.useState)(message);
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_react_transition_group2.CSSTransition, { classNames: "bubble", timeout: 1e3, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        showAvatar && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Avatar, { avatarSrc })
      ]
    }
  ) });
};
...
var ShortTextInput = import_react11.default.forwardRef(function ShortTextInput2(_a2, ref) {
...
var SendIcon = (props) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
  "svg",
  __spreadProps(__spreadValues({
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("path", { d: "M476.59 227.05l-.16-.07L49.35 49.84A23.56 23.56 0 0027.14 52 24.65 24.65 0 0016 72.59v113.29a24 24 0 0019.52 23.57l232.93 43.07a4 4 0 010 7.86L35.53 303.45A24 24 0 0016 327v113.31A23.57 23.57 0 0026.59 460a23.94 23.94 0 0013.22 4 24.55 24.55 0 009.52-1.93L476.4 285.94l.19-.09a32 32 0 000-58.8z" })
  })
);
...
var SendButton = (_a2) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        isLoading && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Spinner, { className: "text-white" }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "xs:flex " + (disableIcon ? "" : "hidden"), children: label }),
...
var Spinner = (props) => /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
  "svg",
...
var EmailInput = ({
  ...
  const [inputValue, setInputValue] = (0, import_react12.useState)(defaultValue != null ? defaultValue : "");
...
var PhoneInput = ({
  ...
  var _a2, _b, _c, _d;
  const [inputValue, setInputValue] = (0, import_react13.useState)(defaultValue != null ? defaultValue : "");
...
var validatePhoneNumber = (phoneNumber) => (0, import_react_phone_number_input2.isPossiblePhoneNumber)(phoneNumber);
...
var UrlInput = ({
  ...
  var _a2, _b, _c, _d, _e, _f;
  const [inputValue, setInputValue] = (0, import_react14.useState)(defaultValue != null ? defaultValue : "");
...
var Textarea = import_react15.default.forwardRef(function Textarea2(_a2, ref) {
  var _b = _a2, { onChange } = _b, props = __objRest(_b, ["onChange"]);
...
var TextInput = ({
  ...
  const [inputValue, setInputValue] = (0, import_react16.useState)(defaultValue != null ? defaultValue : "");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(
    "div",
    {
      ...
      onKeyDown: submitWhenEnter,
      children: [
        isLongText ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
          Textarea,
          {
            ref: inputRef,
            onChange: handleChange,
...
var NumberInput = ({
  ...
  var _a2, _b, _c, _d, _e, _f, _g, _h, _i, _j;
  const [inputValue, setInputValue] = (0, import_react17.useState)(defaultValue != null ? defaultValue : "");
...
var DateForm = ({
  ...
  const [inputValues, setInputValues] = (0, import_react18.useState)({ from: "", to: "" });
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "flex flex-col w-full lg:w-4/6", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { className: "flex items-center", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "flex items-center p-4 " + (isRange ? "pb-0" : ""), children: [
            isRange && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { className: "font-semibold mr-2", children: (_a2 = labels == null ? void 0 : labels.from) != null ? _a2 : "From:" }),
          ...
          isRange && /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "flex items-center p-4", children: [
            isRange && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { className: "font-semibold", children: (_b = labels == null ? void 0 : labels.to) != null ? _b : "To:" }),
            /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
              "input",
              {
...
var ChoiceForm = ({ block, onSubmit }) => {
  ...
  const [selectedIndices, setSelectedIndices] = (0, import_react19.useState)([]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("form", { className: "flex flex-col items-end", onSubmit: handleSubmit, children: [
    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "flex flex-wrap justify-end", children: block.items.map((item, idx) => {
      var _a3, _b2;
      return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("span", { className: "relative inline-flex ml-2 mb-2", children: [
        ...
        isUniqueFirstButton && /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("span", { className: "flex h-3 w-3 absolute top-0 right-0 -mt-1 -mr-1 ping", children: [
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "animate-ping absolute inline-flex h-full w-full rounded-full brightness-225 opacity-75" }),
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "relative inline-flex rounded-full h-3 w-3 brightness-200" })
        ] })
      ] }, item.id);
    }) }),
    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "flex", children: selectedIndices.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
      SendButton,
      {
...
var chatContext = (0, import_react20.createContext)({});
var ChatProvider = ({
  children,
  onScroll
}) => {
...
var useChat = () => (0, import_react20.useContext)(chatContext);
...
var StripePaymentForm = ({ options, onSuccess }) => {
  ...
  const [clientSecret, setClientSecret] = (0, import_react21.useState)("");
  const [amountLabel, setAmountLabel] = (0, import_react21.useState)("");
  ...
  if (!stripe || !clientSecret)
    return /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(Spinner, { className: "text-blue-500" });
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_react_stripe_js2.Elements, { stripe, options: { clientSecret }, children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
    CheckoutForm,
    {
      onSuccess,
      clientSecret,
...
var CheckoutForm = ({
  ...
  const [ignoreFirstPaymentIntentCall, setIgnoreFirstPaymentIntentCall] = (0, import_react21.useState)(true);
  ...
  const [isPayButtonVisible, setIsPayButtonVisible] = (0, import_react21.useState)(false);
  (0, import_react21.useEffect)(() => {
    if (!stripe || !clientSecret)
      return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(
    "form",
    {
      ...
      children: [
        ...
        isPayButtonVisible && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
          SendButton,
          {
        ...
        message && /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(
          "div",
          {
            id: "payment-message",
...
var PaymentForm = ({ onSuccess, options }) => {
  switch (options.provider) {
    case "Stripe" /* STRIPE */:
      return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(StripePaymentForm, { onSuccess, options });
  }
};
...
var RatingForm = ({ block, onSubmit }) => {
  var _a2, _b;
  const [rating, setRating] = (0, import_react22.useState)();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("form", { className: "flex flex-col", onSubmit: handleSubmit, children: [
    block.options.labels.left && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "text-sm w-full mb-2 rating-label", children: block.options.labels.left }),
    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "flex flex-wrap justify-center", children: Array.from(
      Array(
        block.options.length + (block.options.buttonType === "Numbers" ? 1 : 0)
      )
    ).map((_, idx) => /* @__PURE__ */ (0, import_react23.createElement)(
      RatingButton,
    ...
    block.options.labels.right && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "text-sm w-full text-right mb-2 pr-2 rating-label", children: block.options.labels.right }),
    /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "flex justify-end mr-2", children: isDefined(rating) && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
      SendButton,
      {
...
var FileUploadForm = ({
  ...
  const [selectedFiles, setSelectedFiles] = (0, import_react24.useState)([]);
  const [isUploading, setIsUploading] = (0, import_react24.useState)(false);
  const [uploadProgressPercent, setUploadProgressPercent] = (0, import_react24.useState)(0);
  const [isDraggingOver, setIsDraggingOver] = (0, import_react24.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("form", { className: "flex flex-col w-full", onSubmit: handleSubmit, children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      "label",
      {
        ...
        children: isUploading ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_jsx_runtime29.Fragment, { children: selectedFiles.length === 1 ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Spinner, {}) : /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "w-full bg-gray-200 rounded-full h-2.5", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
          "div",
          {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "flex flex-col justify-center items-center", children: [
            selectedFiles.length ? /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("span", { className: "relative", children: [
              /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(FileIcon, {}),
              /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
                "div",
                {
            ...
            ] }) : /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(UploadIcon, {}),
            /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
              "p",
              {
    ...
    selectedFiles.length === 0 && isRequired === false && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "flex justify-end", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      "button",
      {
    ...
    isMultipleAllowed && selectedFiles.length > 0 && !isUploading && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "flex justify-end", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("div", { className: "flex", children: [
      selectedFiles.length && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "button",
        {
    ...
    errorMessage && /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { className: "text-red-500 text-sm", children: errorMessage })
  ] });
};
var UploadIcon = () => /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    ...
    className: "mb-3",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("polyline", { points: "16 16 12 12 8 16" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("line", { x1: "12", y1: "12", x2: "12", y2: "21" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("path", { d: "M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("polyline", { points: "16 16 12 12 8 16" })
    ]
  }
);
var FileIcon = () => /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(
  "svg",
  {
    className: "mb-3",
    xmlns: "http://www.w3.org/2000/svg",
    ...
    strokeLinejoin: "round",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("path", { d: "M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" }),
      /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("polyline", { points: "13 2 13 9 20 9" })
    ]
  }
);
...
var InputChatBlock = ({
  ...
  const [answer, setAnswer] = (0, import_react25.useState)();
  const [isEditting, setIsEditting] = (0, import_react25.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "flex justify-end", children: [
    hasAvatar && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "flex w-6 xs:w-10 h-6 xs:h-10 mr-2 mb-2 mt-1 flex-shrink-0 items-center" }),
...
var Input = ({
  ...
  switch (block.type) {
    ...
    case "date input" /* DATE */:
      return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(DateForm, { options: block.options, onSubmit });
    case "choice input" /* CHOICE */:
      return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(ChoiceForm, { block, onSubmit });
    ...
    case "rating input" /* RATING */:
      return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(RatingForm, { block, onSubmit });
    case "file input" /* FILE */:
      return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(FileUploadForm, { block, onSubmit, onSkip });
  }
};
...
var executeWebhook = (_0, _1) => __async(void 0, [_0, _1], function* (block, {
  ...
  const params = (0, import_qs.stringify)({ resultId });
...
var PopupBlockedToast = ({ url, onLinkClick }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
    "div",
    {
      ...
      role: "alert",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("span", { className: "mb-1 text-sm font-semibold text-gray-900", children: "Popup blocked" }),
        /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { className: "mb-2 text-sm font-normal", children: "The bot wants to open a new tab but it was blocked by your broswer. It needs a manual approval." }),
...
var ChatGroup = ({
  ...
  const { scroll: scroll2 } = useChat();
  const [processedBlocks, setProcessedBlocks] = (0, import_react26.useState)([]);
  const [displayedChunks, setDisplayedChunks] = (0, import_react26.useState)([]);
  const [blockedPopupUrl, setBlockedPopupUrl] = (0, import_react26.useState)();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("div", { className: "flex w-full", "data-group-name": groupTitle, children: /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("div", { className: "flex flex-col w-full min-w-0", children: displayedChunks.map((chunk, idx) => {
    var _a3, _b, _c, _d;
...
var ChatChunks = ({
  ...
  const [isSkipped, setIsSkipped] = (0, import_react26.useState)(false);
  const avatarSideContainerRef = (0, import_react26.useRef)();
  (0, import_react26.useEffect)(() => {
    refreshTopOffset();
  });
  const skipInput = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)(import_jsx_runtime32.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { className: "flex", children: [
      hostAvatar.isEnabled && bubbles.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
        AvatarSideContainer,
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(import_react_transition_group3.TransitionGroup, { children: bubbles.map((block) => /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
            import_react_transition_group3.CSSTransition,
            {
              classNames: "bubble",
              timeout: 500,
              unmountOnExit: true,
    ...
    !isSkipped && /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
      import_react_transition_group3.CSSTransition,
      {
        classNames: "bubble",
        timeout: 500,
        unmountOnExit: true,
        in: isDefined(input),
        children: input ? /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
          InputChatBlock,
          {
            block: input,
    ...
    blockedPopupUrl ? /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("div", { className: "flex justify-end", children: /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(
      PopupBlockedToast,
      {
        url: blockedPopupUrl,
...
var ConversationContainer = ({
  ...
  const [displayedGroups, setDisplayedGroups] = (0, import_react27.useState)([]);
  const { updateVariables } = useAnswers();
  const bottomAnchor = (0, import_react27.useRef)(null);
  const scrollableContainer = (0, import_react27.useRef)(null);
  const [hasStarted, setHasStarted] = (0, import_react27.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(ChatProvider, { onScroll: autoScrollToBottom, children: displayedGroups.map((displayedGroup, idx) => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { className: "w-full h-32", ref: bottomAnchor })
      ]
    }
  );
};
...
var LiteBadge = () => {
  const liteBadge = (0, import_react28.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)(
    "a",
    {
      ...
      children: [
        "Made with ",
        /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("span", { className: "text-blue-500", children: "Typebot" }),
        "."
      ]
    }
  );
...
var TypebotViewer = ({
  ...
  var _a2, _b, _c, _d, _e, _f;
  const containerBgColor = (0, import_react29.useMemo)(
    () => {
      var _a3, _b2, _c2;
  ...
  if (isEmpty(apiHost))
    return /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("p", { children: "process.env.NEXT_PUBLIC_VIEWER_URL is missing in env" });
  return /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("style", { children: [
      phone_default,
      style_default
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("style", { children: (_c = typebot.theme) == null ? void 0 : _c.customCss }),
    /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("style", { children: importantStyles_default }),
    isNotEmpty((_e = (_d = typebot == null ? void 0 : typebot.theme) == null ? void 0 : _d.general) == null ? void 0 : _e.font) && /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
      "style",
      {
        dangerouslySetInnerHTML: {
          ...
          AnswersProvider,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(
              "div",
              {
                ...
                "data-testid": "container",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { className: "flex w-full h-full justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
                  ...
                  typebot.settings.general.isBrandingEnabled && /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(LiteBadge, {})
                ]
              }
            )
          }
