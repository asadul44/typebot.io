...
const getHelpDocUrl = (blockType: BlockWithOptions['type']): string | null => {
  switch (blockType) {
    ...
    case LogicBlockType.SET_VARIABLE:
      return 'https://docs.altbot.io/editor/blocks/logic/set-variable'
    case LogicBlockType.REDIRECT:
      return 'https://docs.altbot.io/editor/blocks/logic/redirect'
    case LogicBlockType.SCRIPT:
      return 'https://docs.altbot.io/editor/blocks/logic/script'
    case LogicBlockType.WAIT:
      return 'https://docs.altbot.io/editor/blocks/logic/wait'
    case InputBlockType.TEXT:
      return 'https://docs.altbot.io/editor/blocks/inputs/text'
    case InputBlockType.NUMBER:
      return 'https://docs.altbot.io/editor/blocks/inputs/number'
    case InputBlockType.EMAIL:
      return 'https://docs.altbot.io/editor/blocks/inputs/email'
    case InputBlockType.URL:
      return 'https://docs.altbot.io/editor/blocks/inputs/website'
    case InputBlockType.DATE:
      return 'https://docs.altbot.io/editor/blocks/inputs/date'
    case InputBlockType.PHONE:
      return 'https://docs.altbot.io/editor/blocks/inputs/phone-number'
    case InputBlockType.CHOICE:
      return 'https://docs.altbot.io/editor/blocks/inputs/buttons'
    case InputBlockType.PAYMENT:
      return 'https://docs.altbot.io/editor/blocks/inputs/payment'
